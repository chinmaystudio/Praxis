/**
 * PRAXIS — Central Event Configuration
 *
 * This file is the single source of truth for all events, rules, assets,
 * and server-authoritative registration fees.
 * Changing `price` here automatically updates both the UI display and
 * the server-side Razorpay order calculation.
 */
